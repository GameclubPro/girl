...
import {
  IconProCertificate as IconCertificate,
  IconProClientVisit as IconClientVisit,
  IconProExperience as IconExperience,
  IconProFormatBoth as IconFormatBoth,
  IconProFormatClientVisit as IconFormatClientVisit,
  IconProFormatMaster as IconFormatMaster,
  IconProHomeMaster as IconHomeMaster,
  IconProLocation as IconPin,
  IconProPhoto as IconPhoto,
  IconProProfileAbout as IconProfileAbout,
  IconProPrice as IconPrice,
  IconProServices as IconServices,
  IconProSchedule as IconSchedule,
  IconProSettings as IconSettings,
  IconTrash,
