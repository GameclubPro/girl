import categoryBeautyNails from '../../1 (10).webp'
import categoryBrowsLashes from '../../2 (8).webp'
import categoryHair from '../../3 (5).webp'
import categoryCosmetologyCare from '../../4.webp'
...
export const collectionItems = [
  ...
  },
  {
    ...
    meta: 'С сертификатами\n4.9 ★ и выше',
    tone: 'lavender',
    categoryId: null,
    cornerImage: collectionVerifiedArt,
    cornerImagePosition: 'bottom-right',
    cornerImageSize: 'clamp(64px, 24vw, 110px)',
    cornerImageRight: '6px',
    cornerImageBottom: '6px',
    cornerImageRotate: '14deg',
  },
  {
    id: 'visit',
    badge: '🚗',
